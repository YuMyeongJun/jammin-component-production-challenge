...
export default meta;
type Story = StoryObj<INewMultipleSelectProp<AnyObject>>;
    ...
    return (
      <div style={{ height: 100, border: '1px solid' }}>
        <MultiSelect
          ...
          gap={args.gap}
          tagFontColor={args.tagFontColor}
          tagStyle={args.tagStyle}
          tagBgColor={args.tagBgColor}
...
export const value: Story = {
  ...
  args: {
    ...
    valuePath: 'test',
    isCheckbox: true,
    value: ['test1test1test1test1', 'test2test2test2test2'],
  },
};
