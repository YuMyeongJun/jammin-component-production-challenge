...
describe("<Autocomplete />", () => {
  it("렌더링 체크", () => {
    ...
    expect(
      autocomplete.classList.contains(autoCompleteClasses.input),
    ).toBeTruthy();
  });

  it("placeholder 체크", () => {
    render(
      <Autocomplete placeholder="test" items={items} displayName={"label"} />,
    );
  ...
  it("input 클릭 시 list목록 출력 체크", () => {
    ...
    console.log(
      "@autoCompleteExClasses.list.root",
  ...
  it("auto complete 작동 여부 체크", async () => {
    ...
    const list = container.querySelector(`.${autoCompleteClasses.root}`)
